...
export default async function SettingsPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8">
      ...
      <section aria-label="Timezone" className="rounded-xl border border-border bg-surface p-4">
        <h2 className="mb-3 text-sm font-medium text-ink-muted">Timezone</h2>
        <TimezoneForm current={timezone} timezones={listTimeZones()} />
      </section>

      <section aria-label="Data" className="rounded-xl border border-border bg-surface p-4">
        <h2 className="mb-3 text-sm font-medium text-ink-muted">Data</h2>
        <DataSection />
      </section>

      <section aria-label="Account" className="rounded-xl border border-border bg-surface p-4">
